...
context('Exercicio - Testes End-to-end - Fluxo de pedido', () => {
    ...
    it('Deve fazer um pedido na loja Ebac Shop de ponta a ponta', () => {
        ...
        cy.get('.select2-search__field').clear().type(faker.address.state()).get('[class="select2-results__option select2-results__option--highlighted"]').click()
        ...
        cy.get('#order_comments').clear().type(faker.lorem.sentence())
