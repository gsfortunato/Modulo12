...
context('Exercicio - Testes End-to-end - Fluxo de pedido', () => {
    ...
    it('Deve editar detalhes de faturamento', () => {
        ...
        cy.get('.woocommerce-notice').should('contain', 'Obrigado. Seu pedido foi recebido')
            ...
            /*
            O site da loja exige que os campos CEP, ESTADO E PAÍS estejam vinculados.
            O faker gera dados aleatório e por isso eu defini estes campos manualmente. 

            Teria como fazer o faker gerar dados aleatórios, porém, Brasileiros?
            */
